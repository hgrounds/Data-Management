...
DROP TABLE projown CASCADE CONSTRAINTS ;
...
CREATE TABLE projown
  (
    projown_id             INTEGER NOT NULL ,
    SIM_Person_person_id   INTEGER NOT NULL ,
    SIM_project_project_id INTEGER NOT NULL
  ) ;
ALTER TABLE projown ADD CONSTRAINT projown_PK PRIMARY KEY ( projown_id ) ;
...
ALTER TABLE projown ADD CONSTRAINT projown_SIM_Person_FK FOREIGN KEY ( SIM_Person_person_id ) REFERENCES SIM_Person ( person_id ) ;

ALTER TABLE projown ADD CONSTRAINT projown_SIM_project_FK FOREIGN KEY ( SIM_project_project_id ) REFERENCES SIM_project ( project_id ) ;
